...
const DropDownOutletCode = ({ data, handle, buttonLabel }: DropdownProps) => {
  ...
  return (
    ...
    >
      <button
        ...
        className="w-full  text-sm font-medium text-gray-900 bg-white border border-gray-100 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 px-5 py-2.5 text-center inline-flex items-center"
        type="button"
...
export default DropDownOutletCode;
